...
// AuditSystemEventLog represents an enriched row ready for parquet writing
type AuditSystemEventLog struct {
...
func NewAuditSystemEventLog() *AuditSystemEventLog {
	return &AuditSystemEventLog{}
}
