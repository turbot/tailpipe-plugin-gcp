...
type AuditSystemEventLogMapper struct {
}

func NewAuditSystemEventLogMapper() table.Mapper[*rows.AuditSystemEventLog] {
	return &AuditSystemEventLogMapper{}
}

func (m *AuditSystemEventLogMapper) Identifier() string {
	return "gcp_audit_system_event_log_mapper"
}

func (m *AuditSystemEventLogMapper) Map(_ context.Context, a any) ([]*rows.AuditSystemEventLog, error) {
	...
	row := rows.NewAuditSystemEventLog()
	...
	return []*rows.AuditSystemEventLog{row}, nil
}
