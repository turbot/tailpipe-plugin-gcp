...
type AuditDataAccessLogMapper struct {
}

func NewAuditDataAccessLogMapper() table.Mapper[*rows.AuditDataAccessLog] {
	return &AuditDataAccessLogMapper{}
}

func (m *AuditDataAccessLogMapper) Identifier() string {
	return "gcp_audit_data_access_log_mapper"
}

func (m *AuditDataAccessLogMapper) Map(_ context.Context, a any) ([]*rows.AuditDataAccessLog, error) {
	...
	row := rows.NewAuditDataAccessLog()
	...
	return []*rows.AuditDataAccessLog{row}, nil
}
